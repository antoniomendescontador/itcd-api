...
INSERT INTO imovel_urbano (matricula,livro,folha,descricao,iptu_inscricao,iptu_terreno,iptu_edificacao,iptu_total,logradouro,numero,complemento,bairro,cep,cidade,estado,valor_avaliado_iptu,valor_avaliado_cub,valor_avaliado_mt_quadr,inventario_extrajudicial_id) 
